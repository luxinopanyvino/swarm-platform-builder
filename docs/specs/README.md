...
| [SPEC-025](SPEC-025-model-benchmark-scientific-writing.md) | Benchmark comparativo de modelos LLM open-source para redacción científica (ruta on-prem/Ollama) | In progress | E13 |
