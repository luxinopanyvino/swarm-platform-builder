...
/** Etiqueta con emoji, como se mostraba antes: «🔍 Investigador». */
function agentBadge(agentId) {
  const meta = agentMeta(agentId);
  return meta.label ? `${meta.emoji} ${meta.label}` : agentId;
}
...
export default function ArticleDetailPage() {
  ...
  // El orden y las etiquetas salen del catálogo del proyecto (T8.6): antes eran
  // una tercera copia de la misma lista, y las tres se editaban por separado.
  const ORDERED_AGENTS = Object.keys(AGENT_CATALOG);
