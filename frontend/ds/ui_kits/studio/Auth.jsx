      ...
      <div className="auth-left">
        <div className="inner">
          <div className="auth-brand">
            ...
            <div><div className="name">Alexandria</div><div className="sub">MAGAZINE</div></div>
          </div>
      ...
      <div className="auth-right">
        <form className="auth-form" onSubmit={(e) => { e.preventDefault(); onLogin({ name: form.name, role: 'Autora' }); }}>
          <div>
            ...
            <p style={{ fontSize: 13.5, color: 'var(--text-muted)', marginTop: 4 }}>{tab === 'login' ? 'Accede a tu espacio de trabajo' : 'Únete a Alexandria Magazine'}</p>
          </div>
